...
- **Свой текст на странице категории** — вкладка «Категории» в админке: пара абзацев над списком товаров превращает листинг в посадочную страницу, а первые предложения уезжают в описание страницы для поисковика вместо сгенерированной фразы.
