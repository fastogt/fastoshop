...
> **Не хотите заниматься сервером?** [fastoshop.by](https://fastoshop.by) — поставим и будем следить: домен, сертификат, бэкапы, обновления и поддержка за 70 BYN в месяц. Это наш платный хостинг; сам FastoShop был и остаётся бесплатным — ставьте на свой VPS и никому ничего не должны.
